  ...
  return (
    <motion.div className="relative flex justify-center items-center mb-12 mt-8 min-h-[40vh]" initial={{
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <motion.div className="absolute top-8 right-1/4 w-32 h-32 bg-openweb/20 rounded-full blur-3xl" animate={{
        scale: [1, 1.3, 1],
        opacity: [0.2, 0.4, 0.2]
      }} transition={{
        duration: 7,
        ...
        <motion.div className="absolute inset-0 opacity-5 bg-cover bg-center -z-20" style={{
      ...
      delay: 0.2
        ...
        duration: 1,
        delay: 0.3
      }} className="absolute -top-10 -right-16 text-white/20" whileHover={{
        scale: 1.1,
        rotate: 5,
        ...
        <h1 className="text-5xl md:text-6xl font-bold text-center">
          <motion.span className="bg-clip-text text-transparent bg-gradient-to-r from-white via-white/90 to-white/70" animate={{
        ...
        }}>SUSSY-HUB</motion.span>
        </h1>
        
        <motion.p className="text-gray-400 text-center mt-3" initial={{
        opacity: 0,
        y: 10
      }} animate={{
        opacity: 1,
      ...
      <motion.div className="absolute w-full max-w-md h-32 bg-gradient-to-r from-jellyfin/30 via-openweb/30 to-filebrowser/30 rounded-full blur-3xl opacity-40 -z-10" animate={{
      opacity: [0.4, 0.6, 0.4],
      width: ["100%", "110%", "100%"]
    }} transition={{
      duration: 10,
      ...
      <motion.div className="absolute -bottom-4 -left-20 w-40 h-40 opacity-10" initial={{
      opacity: 0
    }} animate={{
      opacity: 0.1,
      y: [0, -10, 0],
      ...
      <motion.div className="absolute -bottom-8 -right-16 w-32 h-32 opacity-10" initial={{
      opacity: 0
    }} animate={{
      opacity: 0.1,
      y: [0, -8, 0],
